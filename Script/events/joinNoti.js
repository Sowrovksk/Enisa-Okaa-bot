...
module.exports.run = async function({ api, event }) {
  ...
  const botName = global.config.BOTNAME || "༄𓆩𝐄𝐧𝐢𝐬𝐚𓆪᭄ ♡ ༄𓆩𝐒𝐚𝐲𝐚𝐧𓆪᭄";

 
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    await api.changeNickname(`[ ${botPrefix} ] • ${botName}`, threadID, api.getCurrentUserID());

    api.sendMessage("চ্ঁলে্ঁ এ্ঁসে্ঁছি্ঁ ༄𓆩𝐄𝐧𝐢𝐬𝐚𓆪᭄ ♡ ༄𓆩𝐒𝐚𝐲𝐚𝐧𓆪᭄ এঁখঁনঁ তোঁমাঁদেঁরঁ সাঁথেঁ আঁড্ডাঁ দিঁবঁ..!", threadID, () => {
...
★ যেকোনো অভিযোগ অথবা হেল্প এর জন্য এডমিন 𝐒𝐚𝐲𝐚𝐧 কে নক করতে পারেন ★
➤𝐌𝐞𝐬𝐬𝐞𝐧𝐠𝐞𝐫: https://m.me/61590363572739
➤𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩: https://wa.me/8801854918302

❖⋆═══════════════════════⋆❖
          𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫 ➢ ༄𓆩𝐄𝐧𝐢𝐬𝐚𓆪᭄ ♡ ༄𓆩𝐒𝐚𝐲𝐚𝐧𓆪᭄`;
